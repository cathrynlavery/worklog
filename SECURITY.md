...
HTML digests are self-contained and script-free. They escape checkpoint content before rendering, but they still contain whatever non-secret work details were recorded in the source ledger. Treat them with the same care as the ledger itself.
